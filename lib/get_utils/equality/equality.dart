...
class _ListEquality<E> implements _IEquality<List<E>> {
  ...
  const _ListEquality([_IEquality<E> elementEquality = const _DefaultEquality<Never>()])
...
class _MapEquality<K, V> implements _IEquality<Map<K, V>> {
  ...
  const _MapEquality(
      {_IEquality<K> keys = const _DefaultEquality<Never>(), _IEquality<V> values = const _DefaultEquality<Never>()})
      : _keyEquality = keys,
...
class _IterableEquality<E> implements _IEquality<Iterable<E>> {
  ...
  const _IterableEquality([_IEquality<E> elementEquality = const _DefaultEquality<Never>()])
      : _elementEquality = elementEquality;
...
class _UnorderedIterableEquality<E> extends _UnorderedEquality<E, Iterable<E>> {
  const _UnorderedIterableEquality([_IEquality<E> elementEquality = const _DefaultEquality<Never>()])
